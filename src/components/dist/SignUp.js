...
function SignUp() {
    ...
    var onFinish = function (values) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, api_1["default"]().post("/users/register", values)];
                case 1:
                    _a.sent();
                ...
                case 2:
                    ...
                    showError_1["default"](error_1.response.data.errorMessage);
                    return [3 /*break*/, 3];
    ...
    return (React.createElement(antd_1.Form, __assign({}, layout, { name: "nest-messages", onFinish: onFinish, validateMessages: validateMessages }),
        React.createElement("h1", { style: { textAlign: "center", marginBottom: 40 } }, "Sign Up"),
        React.createElement(antd_1.Form.Item, { name: "username", label: "Username", rules: [{ required: true }] },
            React.createElement(antd_1.Input, null)),
        React.createElement(antd_1.Form.Item, { label: "Password", name: "password", rules: [
                { required: true, message: "Please input your password!", min: 6 },
            ] },
            React.createElement(antd_1.Input.Password, null)),
        React.createElement(antd_1.Form.Item, { name: "email", label: "Email", rules: [{ type: "email", required: true }] },
            React.createElement(antd_1.Input, null)),
        React.createElement(antd_1.Form.Item, { name: "full_name", label: "Full Name" },
            React.createElement(antd_1.Input, null)),
